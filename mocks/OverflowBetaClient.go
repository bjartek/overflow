...
func (_e *OverflowBetaClient_Expecter) AccountPublicKey(name interface{}) *OverflowBetaClient_AccountPublicKey_Call {
	return &OverflowBetaClient_AccountPublicKey_Call{Call: _e.mock.On("AccountPublicKey", name)}
}

func (_c *OverflowBetaClient_AccountPublicKey_Call) Run(run func(name string)) *OverflowBetaClient_AccountPublicKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *OverflowBetaClient_AccountPublicKey_Call) Return(_a0 string, _a1 error) *OverflowBetaClient_AccountPublicKey_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *OverflowBetaClient_AccountPublicKey_Call) RunAndReturn(run func(string) (string, error)) *OverflowBetaClient_AccountPublicKey_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *OverflowBetaClient) GetBlockResult(ctx context.Context, height uint64, logger *zap.Logger) (*overflow.BlockResult, error) {
	ret := _m.Called(ctx, height, logger)

	if len(ret) == 0 {
		panic("no return value specified for GetBlockResult")
	}

	var r0 *overflow.BlockResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, *zap.Logger) (*overflow.BlockResult, error)); ok {
		return rf(ctx, height, logger)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, *zap.Logger) *overflow.BlockResult); ok {
		r0 = rf(ctx, height, logger)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*overflow.BlockResult)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, uint64, *zap.Logger) error); ok {
		r1 = rf(ctx, height, logger)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *OverflowBetaClient_Expecter) GetBlockResult(ctx interface{}, height interface{}, logger interface{}) *OverflowBetaClient_GetBlockResult_Call {
	return &OverflowBetaClient_GetBlockResult_Call{Call: _e.mock.On("GetBlockResult", ctx, height, logger)}
}

func (_c *OverflowBetaClient_GetBlockResult_Call) Run(run func(ctx context.Context, height uint64, logger *zap.Logger)) *OverflowBetaClient_GetBlockResult_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint64), args[2].(*zap.Logger))
	})
	return _c
}

func (_c *OverflowBetaClient_GetBlockResult_Call) Return(_a0 *overflow.BlockResult, _a1 error) *OverflowBetaClient_GetBlockResult_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *OverflowBetaClient_GetBlockResult_Call) RunAndReturn(run func(context.Context, uint64, *zap.Logger) (*overflow.BlockResult, error)) *OverflowBetaClient_GetBlockResult_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *OverflowBetaClient_Expecter) GetOverflowTransactionById(ctx interface{}, id interface{}) *OverflowBetaClient_GetOverflowTransactionById_Call {
	return &OverflowBetaClient_GetOverflowTransactionById_Call{Call: _e.mock.On("GetOverflowTransactionById", ctx, id)}
}

func (_c *OverflowBetaClient_GetOverflowTransactionById_Call) Run(run func(ctx context.Context, id flow.Identifier)) *OverflowBetaClient_GetOverflowTransactionById_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *OverflowBetaClient_GetOverflowTransactionById_Call) Return(_a0 *overflow.OverflowTransaction, _a1 error) *OverflowBetaClient_GetOverflowTransactionById_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *OverflowBetaClient_GetOverflowTransactionById_Call) RunAndReturn(run func(context.Context, flow.Identifier) (*overflow.OverflowTransaction, error)) *OverflowBetaClient_GetOverflowTransactionById_Call {
	_c.Call.Return(run)
	return _c
}

...
func (_c *OverflowClient_Account_Call) RunAndReturn(run func(string) *flowkit.Account) *OverflowClient_Account_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *OverflowClient_AccountE_Call) RunAndReturn(run func(string) (*flowkit.Account, error)) *OverflowClient_AccountE_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *OverflowClient) GetTransactionByBlockId(blockId flow.Identifier) ([]*flow.Transaction, error) {
	ret := _m.Called(blockId)
...
func (_c *OverflowClient_GetTransactionByBlockId_Call) Run(run func(blockId flow.Identifier)) *OverflowClient_GetTransactionByBlockId_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *OverflowClient_GetTransactionByBlockId_Call) RunAndReturn(run func(flow.Identifier) ([]*flow.Transaction, error)) *OverflowClient_GetTransactionByBlockId_Call {
	_c.Call.Return(run)
	return _c
}

// GetTransactionResultByBlockId provides a mock function with given fields: blockId
func (_m *OverflowClient) GetTransactionResultByBlockId(blockId flow.Identifier) ([]*flow.TransactionResult, error) {
	ret := _m.Called(blockId)
...
func (_c *OverflowClient_GetTransactionResultByBlockId_Call) Run(run func(blockId flow.Identifier)) *OverflowClient_GetTransactionResultByBlockId_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(flow.Identifier))
	})
	return _c
...
func (_c *OverflowClient_GetTransactionResultByBlockId_Call) RunAndReturn(run func(flow.Identifier) ([]*flow.TransactionResult, error)) *OverflowClient_GetTransactionResultByBlockId_Call {
	_c.Call.Return(run)
	return _c
}

// GetTransactions provides a mock function with given fields: ctx, id
func (_m *OverflowClient) GetTransactions(ctx context.Context, id flow.Identifier) ([]overflow.OverflowTransaction, error) {
...
// OverflowClient_GetTransactions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTransactions'
type OverflowClient_GetTransactions_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - id flow.Identifier
func (_e *OverflowClient_Expecter) GetTransactions(ctx interface{}, id interface{}) *OverflowClient_GetTransactions_Call {
	return &OverflowClient_GetTransactions_Call{Call: _e.mock.On("GetTransactions", ctx, id)}
}

func (_c *OverflowClient_GetTransactions_Call) Run(run func(ctx context.Context, id flow.Identifier)) *OverflowClient_GetTransactions_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *OverflowClient_GetTransactions_Call) Return(_a0 []overflow.OverflowTransaction, _a1 error) *OverflowClient_GetTransactions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *OverflowClient_GetTransactions_Call) RunAndReturn(run func(context.Context, flow.Identifier) ([]overflow.OverflowTransaction, error)) *OverflowClient_GetTransactions_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *OverflowClient) StreamTransactions(ctx context.Context, poll time.Duration, height uint64, channel chan<- overflow.BlockResult) error {
...
// OverflowClient_StreamTransactions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StreamTransactions'
type OverflowClient_StreamTransactions_Call struct {
	*mock.Call
}
...
func (_e *OverflowClient_Expecter) StreamTransactions(ctx interface{}, poll interface{}, height interface{}, channel interface{}) *OverflowClient_StreamTransactions_Call {
	return &OverflowClient_StreamTransactions_Call{Call: _e.mock.On("StreamTransactions", ctx, poll, height, channel)}
}

func (_c *OverflowClient_StreamTransactions_Call) Run(run func(ctx context.Context, poll time.Duration, height uint64, channel chan<- overflow.BlockResult)) *OverflowClient_StreamTransactions_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *OverflowClient_StreamTransactions_Call) Return(_a0 error) *OverflowClient_StreamTransactions_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *OverflowClient_StreamTransactions_Call) RunAndReturn(run func(context.Context, time.Duration, uint64, chan<- overflow.BlockResult) error) *OverflowClient_StreamTransactions_Call {
	_c.Call.Return(run)
	return _c
}

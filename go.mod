...
require (
	...
	github.com/onflow/flow-cli/flowkit v1.3.3
...
replace github.com/onflow/flow-cli/flowkit => github.com/findonflow/flow-cli/flowkit v0.0.0-20230721100750-76bff4985cde
